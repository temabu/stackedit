...
😄</p>
<ul>
<li class="task-list-item"><input type="checkbox" class="task-list-item-checkbox" checked="true" disabled=""> Another item</li>
<li class="task-list-item"><input type="checkbox" class="task-list-item-checkbox" checked="true" disabled=""> What?</li>
</ul>

<table>
<thead>
<tr>
<th><a href="https://google.no">Norwegian Google</a></th>
<th><a href="https://google.nl">Dutch Google</a></th>
</tr>
</thead>
<tbody>
<tr>
...
</table><pre><code>for each
    do this
end
</code></pre>
<h1 id="files">Files</h1>
<h1 id="robert">ROBERT</h1>
